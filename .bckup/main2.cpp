...
//   emscripten::class_<Kernel::Point_3>("Point_3")
//   .function("x", &Kernel::Point_3::x)
//   .function("y", &Kernel::Point_3::y)
//   .function("z", &Kernel::Point_3::z);
  emscripten::class_<SDFGenerator>("SDFGenerator")
  .constructor<>();
